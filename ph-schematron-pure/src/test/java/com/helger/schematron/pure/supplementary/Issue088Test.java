...
public final class Issue088Test
{
  ...
  {
    _validateAndProduceSVRL (new File ("src/test/resources/external/issues/github88/schematron.sch"),
                             new File ("src/test/resources/external/issues/github88/test.xml"));
  }
}
