...
public final class IssueGC7Test
{
  @Test
  public void testIssue () throws Exception
  {
    validateAndProduceSVRL (new File ("src/test/resources/external/issues/gc7/schematron.sch"),
                            new File ("src/test/resources/external/issues/gc7/test.xml"));
  }
