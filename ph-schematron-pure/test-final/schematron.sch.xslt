...
<!--PATTERN requiredAttribute-->
	...
	<!--RULE -->
<template match="th[@data-role = 'interval'] | td[@data-role = ('interval', 'task')]" mode="M0" priority="1000">
    <ns0:fired-rule xmlns:ns0="http://purl.oclc.org/dsdl/svrl" context="th[@data-role = 'interval'] | td[@data-role = ('interval', 'task')]" />
