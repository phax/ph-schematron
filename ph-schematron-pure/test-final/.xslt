...
<template match="/">
    <ns0:schematron-output xmlns:ns0="http://purl.oclc.org/dsdl/svrl" schemaVersion="" title="">
      ...
      <ns0:ns-prefix-in-attribute-values prefix="sqf" uri="http://example.org/sqf" />
      <ns0:active-pattern>
...
<!--PATTERN -->
	...
	<!--RULE -->
<template match="/file/Customer" mode="M1" priority="1000">
    <ns0:fired-rule xmlns:ns0="http://purl.oclc.org/dsdl/svrl" context="/file/Customer" />

		<!--ASSERT fatal-->
<choose>
      <when test="base-uri()" />
      <otherwise>
        <ns0:failed-assert xmlns:ns0="http://purl.oclc.org/dsdl/svrl" test="base-uri()">
          <attribute name="role">fatal</attribute>
