                                             ...
                                             AbstractSchematronXSLTBasedResource <SchematronResourceSchXslt_XSLT2>
{
   ...
   */
  @NonNull
  public static SchematronResourceSchXslt_XSLT2 compileUncached (@NonNull final IReadableResource aSCHResource)
                                                                                                                throws SchematronException
  {
  ...
  public static final class Builder implements IBuilder <SchematronResourceSchXslt_XSLT2>
  {
     ...
     */
    @NonNull
    public SchematronResourceSchXslt_XSLT2 buildCached (@NonNull final SchematronSchXslt_XSLT2Cache aCache)
                                                                                                            throws SchematronException
    {
