...
import com.helger.schematron.schxslt.xslt2.SchematronSchXslt_XSLT2Config.Builder;
import com.helger.schematron.svrl.jaxb.SchematronOutputType;

/**
 * Builder-driven validator entry point for the SchXslt 1.x engine.
 *
 * @author Philip Helger
 * @since 10.0.0
 */
@NotThreadSafe
public final class SchematronSchXslt_XSLT2 implements ISchematronXSLTBasedValidator
{
  ...
  private SchematronSchXslt_XSLT2 (@NonNull final SchematronSchXslt_XSLT2Config aConfig,
   ...
   */
  @NonNull
  public SchematronSchXslt_XSLT2Config getConfig ()
  {
    return m_aConfig;
  }
   ...
   */
  @NonNull
  public SchematronSchXslt_XSLT2 setOutputValidityDeterminator (@NonNull final ISchematronOutputValidityDeterminator a)
  {
   ...
   */
  @NonNull
  public SchematronSchXslt_XSLT2 setValidateSVRL (final boolean b)
  {
    m_bValidateSVRL = b;
    return this;
  }
  ...
  /**
   * Compile the given config via the {@link SchematronSchXslt_XSLT2Cache#shared() shared cache}.
   *
   * @param aConfig
   *        The configuration to compile. May not be <code>null</code>.
   * @return A new {@link SchematronSchXslt_XSLT2} instance wrapping the compiled provider. Never
   *         <code>null</code>.
   * @throws SchematronException
   *         on compilation error.
   */
  @NonNull
  public static SchematronSchXslt_XSLT2 compileCached (@NonNull final SchematronSchXslt_XSLT2Config aConfig)
                                                                                                            throws SchematronException
  {
    return compileCached (aConfig, SchematronSchXslt_XSLT2Cache.shared ());
  }
                                                       ...
                                                       @NonNull final SchematronSchXslt_XSLT2Cache aCache) throws SchematronException
  {
    ...
    return new SchematronSchXslt_XSLT2 (aConfig, aCache.getOrCompile (aConfig));
  }
   ...
   * @param aConfig
   *        The configuration to compile. May not be <code>null</code>.
   * @return A new {@link SchematronSchXslt_XSLT2} instance wrapping the freshly compiled provider.
   *         Never <code>null</code>.
   * @throws SchematronException
   *         on compilation error.
   */
  @NonNull
  public static SchematronSchXslt_XSLT2 compileUncached (@NonNull final SchematronSchXslt_XSLT2Config aConfig)
                                                                                                              throws SchematronException
  {
    ValueEnforcer.notNull (aConfig, "Config");
    return new SchematronSchXslt_XSLT2 (aConfig, aConfig.compile ());
  }

  /**
   * Shortcut to {@link SchematronSchXslt_XSLT2Config#builder(IReadableResource)}.
   *
   * @param aResource
  ...
  {
    return SchematronSchXslt_XSLT2Config.builder (aResource);
  }
}
