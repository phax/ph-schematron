                                                ...
                                                AbstractSchematronCache <SchematronSchXslt_XSLT2Config, ISchematronXSLTBasedProvider>
{
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger (SchematronSchXslt_XSLT2Cache.class);
   ...
   * any cache. Use this when the caller has a subclassed {@link TransformerCustomizerSchXslt_XSLT2}
   * whose behaviour cannot be expressed via {@link SchematronSchXslt_XSLT2Config}, or when caching
   * is explicitly disabled. Returns <code>null</code> for an invalid Schematron resource; throws on
   ...
   */
  @Nullable
  public static SchematronProviderXSLTFromSchXslt_XSLT2 compileUncached (@NonNull final IReadableResource aSchematronResource,
