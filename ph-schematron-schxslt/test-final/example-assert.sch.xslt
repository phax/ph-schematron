...
<transform xmlns="http://www.w3.org/1999/XSL/Transform" version="2.0">
  <ns0:Description xmlns:ns0="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <ns1:created xmlns:ns1="http://purl.org/dc/terms/">2023-02-10T17:48:54.6451055+01:00</ns1:created>
  </ns0:Description>
  <output indent="yes" />
  <template match="root()">
      ...
      <ns0:metadata xmlns:ns0="http://purl.oclc.org/dsdl/svrl">
        ...
        <ns1:source xmlns:ns1="http://purl.org/dc/terms/">
          <ns2:Description xmlns:ns2="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
            ...
            <ns1:created>2023-02-10T17:48:54.6451055+01:00</ns1:created>
          </ns2:Description>
        </ns1:source>
      </ns0:metadata>
    </variable>
  ...
  <template name="w109aab7">
    <ns0:document xmlns:ns0="https://doi.org/10.5281/zenodo.1495494">
      ...
      <apply-templates mode="w109aab7" select="root()" />
    </ns0:document>
  </template>
  <template match="chapter" mode="w109aab7" priority="0">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w109aab7']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w109aab7">
      ...
      <otherwise>
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w109aab7">
          ...
          <if test="not(title)">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" flag="any" fpi="fpi1" icon="abc" id="id1" location="{schxslt:location(.)}" see="see1" xml:lang="en" xml:space="preserve">
              <attribute name="test">title</attribute>
              <ns1:diagnostic-reference diagnostic="a">
                <ns1:text id="a">Descriptor A <value-of select="@id" />
</ns1:text>
              </ns1:diagnostic-reference>
              <ns1:diagnostic-reference diagnostic="b">
                <ns1:text id="b">Descriptor B <value-of select="@id" />
</ns1:text>
              </ns1:diagnostic-reference>
              <ns1:text xml:lang="en" xml:space="preserve">
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w109aab7')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
