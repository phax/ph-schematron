...
<transform xmlns="http://www.w3.org/1999/XSL/Transform" version="2.0">
  <ns0:Description xmlns:ns0="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <ns1:created xmlns:ns1="http://purl.org/dc/terms/">2023-02-10T17:48:55.1331658+01:00</ns1:created>
  </ns0:Description>
  <output indent="yes" />
  <template match="root()">
      ...
      <ns0:metadata xmlns:ns0="http://purl.oclc.org/dsdl/svrl">
        ...
        <ns1:source xmlns:ns1="http://purl.org/dc/terms/">
          <ns2:Description xmlns:ns2="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
            ...
            <ns1:created>2023-02-10T17:48:55.1331658+01:00</ns1:created>
          </ns2:Description>
        </ns1:source>
      </ns0:metadata>
    </variable>
    ...
    <ns0:schematron-output xmlns:ns0="http://purl.oclc.org/dsdl/svrl" title="Universal Tests">
      <ns0:text>This schema gives the most basic tests for checking an ISO Schematron implementation.
  It does not test the XPath implementation in any significant way, just the basics of assertions,
  rules, patterns, and phases. Use it to "validate" any WF XML document.</ns0:text>
      <ns0:text>The result of running this should be four assertion messages:
 U7, U8, U9, and U10 only.</ns0:text>
  ...
  <template name="w248aac11">
    <ns0:document xmlns:ns0="https://doi.org/10.5281/zenodo.1495494">
      ...
      <ns0:pattern id="w248aac13">
        <if test="exists(base-uri(root()))">
          <attribute name="documents" select="base-uri(root())" />
        </if>
        <for-each select="root()">
          <ns1:active-pattern xmlns:ns1="http://purl.oclc.org/dsdl/svrl" id="p2" name="Always False">
            <attribute name="documents" select="base-uri(.)" />
          </ns1:active-pattern>
        </for-each>
      </ns0:pattern>
      <apply-templates mode="w248aac11" select="root()" />
    </ns0:document>
  </template>
  <template match="/" mode="w248aac11" priority="5">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w248aac11']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac11">
        ...
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac11">
          ...
          <if test="not(true())">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              ...
              <ns1:text>U1: This assertion should never fail.</ns1:text>
            </ns1:failed-assert>
          </if>
          <if test="false()">
            <ns1:successful-report xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              ...
              <ns1:text>U2: This report should never succeed.</ns1:text>
            </ns1:successful-report>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w248aac11')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/*" mode="w248aac11" priority="4">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w248aac11']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac11">
      ...
      <otherwise>
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac11">
          ...
          <if test="not(true())">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">true()</attribute>
              <ns1:text>U3: This assertion should never fail.</ns1:text>
            </ns1:failed-assert>
          </if>
          <if test="false()">
            <ns1:successful-report xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">false()</attribute>
              <ns1:text>U4: This report should never succeed.</ns1:text>
            </ns1:successful-report>
          </if>
        </ns0:rule>
        <next-match>
  ...
  <template match="/*" mode="w248aac11" priority="3">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w248aac11']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac11">
      ...
      <otherwise>
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac11">
          ...
          <if test="not(false())">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">false()</attribute>
              <ns1:text>U5: This assertion should never succeed because the rule should never fire.</ns1:text>
            </ns1:failed-assert>
          </if>
          <if test="true()">
            <ns1:successful-report xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">true()</attribute>
              <ns1:text>U6: This report should never succeed because the rule should never fire.</ns1:text>
            </ns1:successful-report>
          </if>
        </ns0:rule>
        <next-match>
  ...
  <template match="/" mode="w248aac11" priority="2">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w248aac13']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac13">
          <comment>WARNING: Rule for context "/" shadowed by preceding rule</comment>
          <ns1:suppressed-rule xmlns:ns1="http://purl.oclc.org/dsdl/svrl">
            <attribute name="context">/</attribute>
          </ns1:suppressed-rule>
      ...
      <otherwise>
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac13">
          ...
          <if test="not(false())">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">false()</attribute>
              <ns1:text>U7: This assertion should always fail.</ns1:text>
            </ns1:failed-assert>
          </if>
          <if test="true()">
            <ns1:successful-report xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">true()</attribute>
              <ns1:text>U8: This report should always succeed.</ns1:text>
            </ns1:successful-report>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w248aac13')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/*" mode="w248aac11" priority="1">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w248aac13']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac13">
      ...
      <otherwise>
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac13">
          ...
          <if test="not(false())">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">false()</attribute>
              <ns1:text>U9: This assertion should always fail.</ns1:text>
            </ns1:failed-assert>
          </if>
          <if test="true()">
            <ns1:successful-report xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">true()</attribute>
              <ns1:text>U10: This report should always succeed.</ns1:text>
            </ns1:successful-report>
          </if>
        </ns0:rule>
        <next-match>
  ...
  <template match="/*" mode="w248aac11" priority="0">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w248aac13']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac13">
      ...
      <otherwise>
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w248aac13">
          ...
          <if test="not(false())">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">false()</attribute>
              <ns1:text>U11: This assertion should never succeed because the rule should never fire.</ns1:text>
            </ns1:failed-assert>
          </if>
          <if test="true()">
            <ns1:successful-report xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">true()</attribute>
              <ns1:text>U12: This report should never succeeed because the rule should never fire.</ns1:text>
            </ns1:successful-report>
          </if>
        </ns0:rule>
        <next-match>
