...
<transform xmlns="http://www.w3.org/1999/XSL/Transform" version="2.0">
  <ns0:Description xmlns:ns0="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <ns1:created xmlns:ns1="http://purl.org/dc/terms/">2022-11-17T08:43:08.546+01:00</ns1:created>
  </ns0:Description>
  <output indent="yes" />
  <template match="root()">
      ...
      <ns0:metadata xmlns:ns0="http://purl.oclc.org/dsdl/svrl">
        ...
        <ns1:source xmlns:ns1="http://purl.org/dc/terms/">
          <ns2:Description xmlns:ns2="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
            ...
            <ns1:created>2022-11-17T08:43:08.546+01:00</ns1:created>
          </ns2:Description>
        </ns1:source>
      </ns0:metadata>
    </variable>
  ...
  <template name="w1083aab1">
    <ns0:document xmlns:ns0="https://doi.org/10.5281/zenodo.1495494">
      <ns0:pattern id="w1083aab1">
        <if test="exists(base-uri(root()))">
          <attribute name="documents" select="base-uri(root())" />
        </if>
        <for-each select="root()">
          <ns1:active-pattern xmlns:ns1="http://purl.oclc.org/dsdl/svrl" id="VoteCount" name="VoteCount">
            <attribute name="documents" select="base-uri(.)" />
          </ns1:active-pattern>
        </for-each>
      </ns0:pattern>
      <ns0:pattern id="w1083aab3">
        <if test="exists(base-uri(root()))">
          <attribute name="documents" select="base-uri(root())" />
        </if>
        <for-each select="root()">
          <ns1:active-pattern xmlns:ns1="http://purl.oclc.org/dsdl/svrl" id="Checksum" name="Checksum">
            <attribute name="documents" select="base-uri(.)" />
          </ns1:active-pattern>
        </for-each>
      </ns0:pattern>
      <apply-templates mode="w1083aab1" select="root()" />
    </ns0:document>
  </template>
  <template match="ResultsByPercentage" mode="w1083aab1" priority="1">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w1083aab1']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w1083aab1">
          <comment>WARNING: Rule for context "ResultsByPercentage" shadowed by preceding rule</comment>
          <ns1:suppressed-rule xmlns:ns1="http://purl.oclc.org/dsdl/svrl">
            <attribute name="context">ResultsByPercentage</attribute>
          </ns1:suppressed-rule>
        </ns0:rule>
        <next-match>
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w1083aab1')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="DocumentNumber" mode="w1083aab1" priority="0">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w1083aab3']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w1083aab3">
          <comment>WARNING: Rule for context "DocumentNumber" shadowed by preceding rule</comment>
          <ns1:suppressed-rule xmlns:ns1="http://purl.oclc.org/dsdl/svrl">
            <attribute name="context">DocumentNumber</attribute>
          </ns1:suppressed-rule>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="$schxslt:patterns-matched" />
      ...
      <otherwise>
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w1083aab3">
          ...
          <if test="not((                              (number(substring(.,1,1)) * 1) +                              (number(substring(.,2,1)) * 2) +                              (number(substring(.,3,1)) * 3) +                              (number(substring(.,4,1)) * 4) +                              (number(substring(.,5,1)) * 5) +                              (number(substring(.,6,1)) * 6) +                              (number(substring(.,7,1)) * 7) +                              (number(substring(.,8,1)) * 8) +                              (number(substring(.,9,1)) * 9)                            ) mod 9 = number(substring(.,10,1))                            )">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">(                              (number(substring(.,1,1)) * 1) +                              (number(substring(.,2,1)) * 2) +                              (number(substring(.,3,1)) * 3) +                              (number(substring(.,4,1)) * 4) +                              (number(substring(.,5,1)) * 5) +                              (number(substring(.,6,1)) * 6) +                              (number(substring(.,7,1)) * 7) +                              (number(substring(.,8,1)) * 8) +                              (number(substring(.,9,1)) * 9)                            ) mod 9 = number(substring(.,10,1))                            </attribute>
              <ns1:text>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w1083aab3')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
