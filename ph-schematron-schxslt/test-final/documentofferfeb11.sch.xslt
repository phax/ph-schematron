...
<transform xmlns="http://www.w3.org/1999/XSL/Transform" version="2.0">
  <ns0:Description xmlns:ns0="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <ns1:created xmlns:ns1="http://purl.org/dc/terms/">2022-11-17T08:43:07.974+01:00</ns1:created>
  </ns0:Description>
  <output indent="yes" />
  <template match="root()">
      ...
      <ns0:metadata xmlns:ns0="http://purl.oclc.org/dsdl/svrl">
        ...
        <ns1:source xmlns:ns1="http://purl.org/dc/terms/">
          <ns2:Description xmlns:ns2="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
            ...
            <ns1:created>2022-11-17T08:43:07.974+01:00</ns1:created>
          </ns2:Description>
        </ns1:source>
      </ns0:metadata>
    </variable>
    ...
    <ns0:schematron-output xmlns:ns0="http://purl.oclc.org/dsdl/svrl" schemaVersion="iso" title="Schematron for DocumentOffer">
  ...
  <template name="w679aac17">
    <ns0:document xmlns:ns0="https://doi.org/10.5281/zenodo.1495494">
      ...
      <apply-templates mode="w679aac17" select="root()" />
    </ns0:document>
  </template>
  <template match="/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:Delivery/p1:DeliveryDetails" mode="w679aac17" priority="19">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac17']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac17">
        ...
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac17">
          ...
          <if test="not(not(p1:DeliveryDateConfirmed))">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              ...
              <ns1:text>
	Regel 1: Element '/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:Delivery/p1:DeliveryDetails/p1:DeliveryDateConfirmed' soll in diesem Kontext nicht verwendet werden.</ns1:text>
            </ns1:failed-assert>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac17')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:Delivery/p1:DeliveryDetails" mode="w679aac17" priority="18">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac21']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac21">
          <comment>WARNING: Rule for context "/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:Delivery/p1:DeliveryDetails" shadowed by preceding rule</comment>
          <ns1:suppressed-rule xmlns:ns1="http://purl.oclc.org/dsdl/svrl">
            <attribute name="context">/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:Delivery/p1:DeliveryDetails</attribute>
          </ns1:suppressed-rule>
        ...
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac21">
          ...
          <if test="not(not(p1:ShippingDate))">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              ...
              <ns1:text>
	Regel 2: Element 'p1:ShippingDate' soll in diesem Kontext nicht verwendet werden.</ns1:text>
            </ns1:failed-assert>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac21')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem" mode="w679aac17" priority="17">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac25']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac25">
        ...
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac25">
          ...
          <if test="not(p1:UnitPrice)">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              ...
              <ns1:text>
	Regel 3: Das Element 'p1:UnitPrice' ist in diesem Kontext erforderlich.</ns1:text>
            </ns1:failed-assert>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac25')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:TaxRate" mode="w679aac17" priority="16">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac29']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac29">
        ...
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac29">
          ...
          <if test="not(@p1:TaxCode)">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              ...
              <ns1:text>
	Regel 4: Das Attribut '@p1:TaxCode' ist in diesem Kontext erforderlich.</ns1:text>
            </ns1:failed-assert>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac29')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:PaymentConditions/p1:Discount" mode="w679aac17" priority="15">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac33']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac33">
      ...
      <otherwise>
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac33">
          ...
          <if test="not(count(p1:PaymentDate)=1)">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">count(p1:PaymentDate)=1</attribute>
              <ns1:text>
	Regel 5: Das Element 'p1:PaymentDate' muss genau 1 mal auftreten.</ns1:text>
            </ns1:failed-assert>
          </if>
          <if test="not(count(p1:Percentage)=1)">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">count(p1:Percentage)=1</attribute>
              <ns1:text>
	Regel 6: Das Element 'p1:Percentage' muss genau 1 mal auftreten.</ns1:text>
            </ns1:failed-assert>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac33')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:ReductionDetails/p1:Reduction/p1:TaxRate" mode="w679aac17" priority="14">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac37']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac37">
        ...
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac37">
          ...
          <if test="not(@p1:TaxCode)">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">@p1:TaxCode</attribute>
              <ns1:text>
	Regel 7: Das Attribut '@p1:TaxCode' ist in diesem Kontext erforderlich.</ns1:text>
            </ns1:failed-assert>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac37')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Tax/p1:VAT/p1:Item/p1:TaxRate" mode="w679aac17" priority="13">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac41']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac41">
        ...
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac41">
          ...
          <if test="not(@p1:TaxCode)">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">@p1:TaxCode</attribute>
              <ns1:text>
	Regel 8: Das Attribut '@p1:TaxCode' ist in diesem Kontext erforderlich.</ns1:text>
            </ns1:failed-assert>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac41')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Supplier/p1:Address" mode="w679aac17" priority="12">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac45']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac45">
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac45')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Customer/p1:Address" mode="w679aac17" priority="11">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac49']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac49">
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac49')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:OrderingParty/p1:Address" mode="w679aac17" priority="10">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac53']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac53">
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac53')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Shipper/p1:Address" mode="w679aac17" priority="9">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac57']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac57">
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac57')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Delivery/p1:DeliveryRecipient/p1:Address" mode="w679aac17" priority="8">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac61']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac61">
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac61')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:ArticleNumber" mode="w679aac17" priority="7">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac65']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac65">
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac65')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Delivery/p1:DeliveryDetails" mode="w679aac17" priority="6">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac69']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac69">
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac69')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Delivery/p1:DeliveryDetails/p1:Period" mode="w679aac17" priority="5">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac73']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac73">
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac73')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:Delivery/p1:DeliveryDetails" mode="w679aac17" priority="4">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac77']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac77">
          <comment>WARNING: Rule for context "/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:Delivery/p1:DeliveryDetails" shadowed by preceding rule</comment>
          <ns1:suppressed-rule xmlns:ns1="http://purl.oclc.org/dsdl/svrl">
            <attribute name="context">/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:Delivery/p1:DeliveryDetails</attribute>
          </ns1:suppressed-rule>
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac77')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem/p1:Delivery/p1:DeliveryDetails/p1:Period" mode="w679aac17" priority="3">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac81']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac81">
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac81')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem" mode="w679aac17" priority="2">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac85']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac85">
          <comment>WARNING: Rule for context "/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem" shadowed by preceding rule</comment>
          <ns1:suppressed-rule xmlns:ns1="http://purl.oclc.org/dsdl/svrl">
            <attribute name="context">/p1:Document/p1:Details/p1:ItemList/p1:ListLineItem</attribute>
          </ns1:suppressed-rule>
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac85')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document" mode="w679aac17" priority="1">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac89']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac89">
        ...
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac89">
          ...
          <if test="not(p1:TotalGrossAmount)">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              ...
              <ns1:text>
			   Regel 20: Ein TotalGrossAmount muß in Document angegeben werden.</ns1:text>
            </ns1:failed-assert>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac89')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
  <template match="/p1:Document" mode="w679aac17" priority="0">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w679aac93']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac93">
          <comment>WARNING: Rule for context "/p1:Document" shadowed by preceding rule</comment>
          <ns1:suppressed-rule xmlns:ns1="http://purl.oclc.org/dsdl/svrl">
            <attribute name="context">/p1:Document</attribute>
          </ns1:suppressed-rule>
      ...
      <otherwise>
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w679aac93">
          ...
          <if test="not(@p1:DocumentType='Offer')">
            <ns1:failed-assert xmlns:ns1="http://purl.oclc.org/dsdl/svrl" location="{schxslt:location(.)}">
              <attribute name="test">@p1:DocumentType='Offer'</attribute>
              <ns1:text>
			  Regel 21: Der DocumentType entspricht nicht einer Offer</ns1:text>
            </ns1:failed-assert>
          </if>
        </ns0:rule>
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w679aac93')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
