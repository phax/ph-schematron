...
<transform xmlns="http://www.w3.org/1999/XSL/Transform" version="2.0">
  <ns0:Description xmlns:ns0="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <ns1:created xmlns:ns1="http://purl.org/dc/terms/">2023-02-22T09:22:26.0404465+01:00</ns1:created>
  </ns0:Description>
  <output indent="yes" />
  <template match="root()">
  ...
  <template name="w21156aab3">
    <ns0:document xmlns:ns0="https://doi.org/10.5281/zenodo.1495494">
      ...
      <apply-templates mode="w21156aab3" select="root()" />
    </ns0:document>
  </template>
  <template match="tag1" mode="w21156aab3" priority="0">
    <param as="xs:string*" name="schxslt:patterns-matched" />
    <choose>
      <when test="$schxslt:patterns-matched[. = 'w21156aab3']">
        <ns0:rule xmlns:ns0="https://doi.org/10.5281/zenodo.1495494" pattern="w21156aab3">
          <comment>WARNING: Rule for context "tag1" shadowed by preceding rule</comment>
          <ns1:suppressed-rule xmlns:ns1="http://purl.oclc.org/dsdl/svrl">
            <attribute name="context">tag1</attribute>
          </ns1:suppressed-rule>
        </ns0:rule>
        <next-match>
      ...
      <otherwise>
        ...
        <next-match>
          <with-param as="xs:string*" name="schxslt:patterns-matched" select="($schxslt:patterns-matched, 'w21156aab3')" />
        </next-match>
      </otherwise>
    </choose>
  </template>
