...
<!--KEYS AND FUNCTIONS-->
<key match="//DataSets/DataSet[@Name='Books']/Property/Property[@Name='Title']" name="keyTitles" use="@Value" />
...
<!--SCHEMA SETUP-->
<template match="/">
    <ns0:schematron-output xmlns:ns0="http://purl.oclc.org/dsdl/svrl" schemaVersion="ISO19757-3" title="ISO schematron validation file for descriptive extended&#xA;&#x9;&#x9;constraints">
      <comment>
      ...
      <ns0:active-pattern>
        ...
        <attribute name="id">CheckBooks_UniqueTitle</attribute>
        <attribute name="name">CheckBooks_UniqueTitle</attribute>
        <apply-templates />
      </ns0:active-pattern>
...
<!--SCHEMATRON PATTERNS-->
<ns0:text xmlns:ns0="http://purl.oclc.org/dsdl/svrl">ISO schematron validation file for descriptive extended
		constraints</ns0:text>

<!--PATTERN CheckBooks_UniqueTitle-->


	<!--RULE -->
<template match="//DataSets/DataSet[@Name='Books']/Property" mode="M2" priority="1000">
    <ns0:fired-rule xmlns:ns0="http://purl.oclc.org/dsdl/svrl" context="//DataSets/DataSet[@Name='Books']/Property" />

		<!--ASSERT warning-->
<choose>
      <when test="count(key('keyTitles',Property/@Value)) = 1" />
      <otherwise>
        <ns0:failed-assert xmlns:ns0="http://purl.oclc.org/dsdl/svrl" test="count(key('keyTitles',Property/@Value)) = 1">
    ...
    <apply-templates mode="M2" select="@*|*|comment()|processing-instruction()" />
  </template>
