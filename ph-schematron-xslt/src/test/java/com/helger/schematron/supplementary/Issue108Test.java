...
public final class Issue108Test
{
  ...
  {
    _validateAndProduceSVRL (new File ("src/test/resources/external/issues/github108/schematron.sch"),
                             new File ("src/test/resources/external/issues/github108/test.xml"));
  }
}
