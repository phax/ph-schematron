...
public final class Issue101Test
{
  ...
  {
    _validateAndProduceSVRL (new File ("src/test/resources/external/issues/github101/schematron.sch"),
                             new File ("src/test/resources/external/issues/github101/test.xml"));
  }
}
