...
/**
 * Test class for {@link ISchematronTemplateTelemetry} integration with the pre-built XSLT engine.
 *
 * @author Philip Helger
 */
public final class SchematronXSLTTelemetryTest
{
  ...
  {
    final SchematronXSLTConfig aPlain = SchematronXSLTConfig.builder (VALID_XSLT_SCHEMATRON).build ();
    final SchematronXSLTConfig aTraced = SchematronXSLTConfig.builder (VALID_XSLT_SCHEMATRON)
