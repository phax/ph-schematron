 ...
 * {@link SchematronXSLTConfig} (pre-built XSLT scripts).
 *
...
public final class SchematronXSLTCache extends AbstractSchematronCache <SchematronXSLTConfig, ISchematronXSLTBasedProvider>
{
  ...
  {
    static final SchematronXSLTCache INSTANCE = new SchematronXSLTCache ();
  }

  /**
   * Create a new, unbounded cache with the {@link #DEFAULT_NAME default name}.
   */
  public SchematronXSLTCache ()
  {
   ...
   */
  public SchematronXSLTCache (@NonNull @Nonempty final String sName)
  {
   ...
   */
  public SchematronXSLTCache (@NonNull @Nonempty final String sName, final int nMaxSize)
  {
   ...
   */
  @NonNull
  public static SchematronXSLTCache shared ()
  {
