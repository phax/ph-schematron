...
/**
 * Test class for {@link ISchematronTemplateTelemetry} integration with the ISO Schematron XSLT2
 * engine.
 *
 * @author Philip Helger
 */
public final class SchematronSCHTelemetryTest
{
  ...
  {
    final SchematronSCHConfig aPlain = SchematronSCHConfig.builder (VALID_SCHEMATRON).build ();
    final SchematronSCHConfig aTraced = SchematronSCHConfig.builder (VALID_SCHEMATRON)
