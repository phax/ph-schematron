 ...
 * {@link SchematronSCHConfig}. Use {@link #shared()} for the process-wide singleton, or
 * <code>new SchematronSCHCache()</code> to keep an isolated cache (e.g. for tests or per-tenant
 * isolation).
 *
...
public final class SchematronSCHCache extends AbstractSchematronCache <SchematronSCHConfig, ISchematronXSLTBasedProvider>
{
  ...
  {
    static final SchematronSCHCache INSTANCE = new SchematronSCHCache ();
  }

  /**
   * Create a new, unbounded cache with the {@link #DEFAULT_NAME default name}.
   */
  public SchematronSCHCache ()
  {
   ...
   */
  public SchematronSCHCache (@NonNull @Nonempty final String sName)
  {
   ...
   */
  public SchematronSCHCache (@NonNull @Nonempty final String sName, final int nMaxSize)
  {
   ...
   */
  @NonNull
  public static SchematronSCHCache shared ()
  {
