...
public class SchematronProviderXSLTFromSCH implements ISchematronXSLTBasedProvider
{
   ...
   */
  private static void _applyConfigToTransformer (@NonNull final SchematronSCHConfig aConfig,
  ...
  @NonNull
  public static Document createSchematronXSLT (@NonNull final SchematronSCHConfig aConfig) throws TransformerException
  {
   ...
   */
  protected SchematronProviderXSLTFromSCH (@NonNull final SchematronSCHConfig aConfig)
  {
    ValueEnforcer.notNull (aConfig, "Config");
    m_aConfig = aConfig;
  }
