 ...
 * <p>
 * The cache-key dimensions are <code>(resourceID, phase, languageCode)</code>; runtime hooks
...
public final class SchematronSCHConfig implements ISchematronCompilation <ISchematronXSLTBasedProvider>
{
  ...
  public static final class CacheKey
  {
    ...
    public String toString ()
    {
      return "SchematronSCHConfig.CacheKey[" +
             m_sResourceID +
             ":" +
   ...
   */
  @NotThreadSafe
  public static final class Builder implements IBuilder <SchematronSCHConfig>
  {
    private final IReadableResource m_aResource;
