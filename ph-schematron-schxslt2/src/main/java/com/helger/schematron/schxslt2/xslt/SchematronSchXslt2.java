...
import com.helger.schematron.schxslt2.xslt.SchematronSchXslt2Config.Builder;
import com.helger.schematron.svrl.jaxb.SchematronOutputType;

/**
 * Builder-driven validator entry point for the SchXslt 2.x engine.
 *
 * @author Philip Helger
 * @since 10.0.0
 */
@NotThreadSafe
public final class SchematronSchXslt2 implements ISchematronXSLTBasedValidator
{
  ...
  private SchematronSchXslt2 (@NonNull final SchematronSchXslt2Config aConfig,
   ...
   */
  @NonNull
  public SchematronSchXslt2Config getConfig ()
  {
    return m_aConfig;
  }
   ...
   */
  @NonNull
  public SchematronSchXslt2 setOutputValidityDeterminator (@NonNull final ISchematronOutputValidityDeterminator a)
  {
   ...
   */
  @NonNull
  public SchematronSchXslt2 setValidateSVRL (final boolean b)
  {
    m_bValidateSVRL = b;
    return this;
  }
  ...
  /**
   * Compile the given config via the {@link SchematronSchXslt2Cache#shared() shared cache}.
   *
   * @param aConfig
   *        The configuration to compile. May not be <code>null</code>.
   * @return A new {@link SchematronSchXslt2} instance wrapping the compiled provider. Never
   *         <code>null</code>.
   * @throws SchematronException
   *         on compilation error.
   */
  @NonNull
  public static SchematronSchXslt2 compileCached (@NonNull final SchematronSchXslt2Config aConfig) throws SchematronException
  {
    return compileCached (aConfig, SchematronSchXslt2Cache.shared ());
  }
   ...
   */
  @NonNull
  public static SchematronSchXslt2 compileCached (@NonNull final SchematronSchXslt2Config aConfig,
                                                  @NonNull final SchematronSchXslt2Cache aCache) throws SchematronException
  {
    ValueEnforcer.notNull (aConfig, "Config");
    ValueEnforcer.notNull (aCache, "Cache");
    return new SchematronSchXslt2 (aConfig, aCache.getOrCompile (aConfig));
  }
   ...
   * @param aConfig
   *        The configuration to compile. May not be <code>null</code>.
   * @return A new {@link SchematronSchXslt2} instance wrapping the freshly compiled provider.
   *         Never <code>null</code>.
   * @throws SchematronException
   *         on compilation error.
   */
  @NonNull
  public static SchematronSchXslt2 compileUncached (@NonNull final SchematronSchXslt2Config aConfig)
                                                                                                     throws SchematronException
  {
    ValueEnforcer.notNull (aConfig, "Config");
    return new SchematronSchXslt2 (aConfig, aConfig.compile ());
  }

  /**
   * Shortcut to {@link SchematronSchXslt2Config#builder(IReadableResource)}.
   *
   * @param aResource
  ...
  {
    return SchematronSchXslt2Config.builder (aResource);
  }
}
