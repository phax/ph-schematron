...
public final class SchematronSchXslt2CacheTest
{
  ...
  public void testValidSynchronous () throws Exception
  {
    ...
    SchematronResourceSchXslt2.builder (new ClassPathResource (VALID_SCHEMATRON)).build ().isValidSchematron ();
  ...
  {
    assertFalse (SchematronResourceSchXslt2.builder (new ClassPathResource ("test-sch/invalid01.sch"))
                                           .useCache (false)
                                           .build ()
                                           .isValidSchematron ());
    assertFalse (SchematronResourceSchXslt2.builder (new ClassPathResource ("test-sch/this.file.does.not.exists"))
                                           .useCache (false)
                                           .build ()
                                           .isValidSchematron ());

    assertFalse (SchematronResourceSchXslt2.builder (new FileSystemResource ("src/test/resources/test-sch/invalid01.sch"))
                                           .useCache (false)
                                           .build ()
                                           .isValidSchematron ());
    assertFalse (SchematronResourceSchXslt2.builder (new FileSystemResource ("src/test/resources/test-sch/this.file.does.not.exists"))
                                           .useCache (false)
                                           .build ()
                                           .isValidSchematron ());
  }
