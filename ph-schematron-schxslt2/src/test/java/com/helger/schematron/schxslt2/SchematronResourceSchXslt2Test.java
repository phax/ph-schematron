...
public final class SchematronResourceSchXslt2Test
{
  ...
  {
    final SchematronResourceSchXslt2 aSCH = SchematronResourceSchXslt2.builderFromClassPath ("external/schematron/iso-schematron-2006.sch")
                                                                      .build ();
  ...
  {
    final SchematronResourceSchXslt2 aSCH = SchematronResourceSchXslt2.builderFromClassPath ("external/schematron/iso-schematron-2016.sch")
                                                                      .build ();
    assertTrue (aSCH.isValidSchematron ());
  }
}
