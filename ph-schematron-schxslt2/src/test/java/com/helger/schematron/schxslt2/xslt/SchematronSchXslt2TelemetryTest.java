...
/**
 * Test class for {@link ISchematronTemplateTelemetry} integration with the SchXslt 2.x engine.
 *
 * @author Philip Helger
 */
public final class SchematronSchXslt2TelemetryTest
{
  ...
  public void testTelemetryReceivesTemplateEvents () throws Exception
  {
    ...
    final SchematronSchXslt2 aValidator = SchematronSchXslt2.builder (VALID_SCHEMATRON)
  ...
  {
    final SchematronSchXslt2 aValidator = SchematronSchXslt2.builder (VALID_SCHEMATRON).buildUncached ();
    assertTrue ("invalid schematron", aValidator.isValidSchematron ());
  ...
  {
    final SchematronSchXslt2Config aPlain = SchematronSchXslt2Config.builder (VALID_SCHEMATRON).build ();
    final SchematronSchXslt2Config aTraced = SchematronSchXslt2Config.builder (VALID_SCHEMATRON)
