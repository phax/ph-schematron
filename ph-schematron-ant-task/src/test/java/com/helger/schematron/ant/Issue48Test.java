...
{
  private static final Logger LOGGER = LoggerFactory.getLogger (Issue48Test.class);
  ...
  public void init ()
  {
    m_aBuildRule.configureProject ("src/test/resources/external/issues/48/build.xml");
