...
public final class Issue57Test
{
  private static final Logger LOGGER = LoggerFactory.getLogger (Issue57Test.class);
  ...
  public void init ()
  {
    m_aBuildRule.configureProject ("src/test/resources/external/issues/57/build.xml");
