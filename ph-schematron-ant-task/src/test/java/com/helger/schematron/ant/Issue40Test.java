...
{
  private static final Logger LOGGER = LoggerFactory.getLogger (Issue40Test.class);
  ...
  public void init ()
  {
    m_aBuildRule.configureProject ("src/test/resources/external/issues/40/build.xml");
