...
public final class Issue62Test
{
  private static final Logger LOGGER = LoggerFactory.getLogger (Issue62Test.class);
  ...
  public void init ()
  {
    m_aBuildRule.configureProject ("src/test/resources/external/issues/62/build.xml");
