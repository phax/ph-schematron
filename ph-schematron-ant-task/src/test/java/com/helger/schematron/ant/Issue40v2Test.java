...
{
  private static final Logger LOGGER = LoggerFactory.getLogger (Issue40v2Test.class);
  ...
  public void init ()
  {
    m_aBuildRule.configureProject ("src/test/resources/external/issues/40v2/build.xml");
