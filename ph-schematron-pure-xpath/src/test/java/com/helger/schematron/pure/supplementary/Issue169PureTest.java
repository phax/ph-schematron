...
public final class Issue169PureTest
{
  private static final Logger LOGGER = LoggerFactory.getLogger (Issue169PureTest.class);
  ...
  {
    final SchematronResourcePureXPath aSCH = SchematronResourcePureXPath.builder (aSchematron).build ();
  ...
  {
    validateAndProduceSVRL (new ClassPathResource ("external/issue169/complete-validation.sch",
