 ...
 */
package com.helger.schematron.puresaxon.supplementary;
 ...
 */
public final class IssueGlobalLetSaxonTest
{
  private static final Logger LOGGER = LoggerFactory.getLogger (IssueGlobalLetSaxonTest.class);
  ...
  public static void validateAndProduceSVRL (final File aSchematron, final File aXML) throws Exception
  {
    ...
    final SchematronResourceSaxon aSch = new SchematronResourceSaxon (aSchRes);
