...
/**
 * Sweep test: runs {@link SchematronResourceSaxon} over every Schematron file shipped by
 ...
 */
public final class SchematronResourceSaxonSweepTest
{
  private static final Logger LOGGER = LoggerFactory.getLogger (SchematronResourceSaxonSweepTest.class);
  ...
  public void testParseAndCompileAllValidSchematrons ()
  {
    ...
    {
      nTotal++;
      final SchematronResourceSaxon aSch = new SchematronResourceSaxon (aRes).setErrorHandler (new DoNothingPSErrorHandler ());
      try
      {
